...
public class MainActivity extends AppCompatActivity implements BiometricCallback {
    ...
    private Button btn_Bio_authenticate,btn_CallerIdentification;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        btn_Bio_authenticate = findViewById(R.id.btn_authenticate);
        btn_Bio_authenticate.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btn_CallerIdentification = findViewById(R.id.btn_CallerIdentification);
        btn_CallerIdentification.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this,CallerIdentification.class);
                startActivity(i);
            }
        });
    }
